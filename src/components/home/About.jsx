...
const About = () => {
  return (
    <section className="py-24 md:py-32 px-6 md:px-12 bg-[#FAFBFF] overflow-hidden">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-24">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-serif text-brand-blue leading-tight mb-8">
              DESIGN IS ONLY HALF THE WORK.
            </h2>
            <p className="text-sm font-light text-brand-blue/80 leading-relaxed mb-6">
          ...
          <div className="md:col-span-7">
            <motion.div 
              className="aspect-[4/3] rounded-3xl relative overflow-hidden group shadow-glass border border-brand-blue/10"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-100px" }}
